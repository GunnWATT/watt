            ...
            <section className="flex flex-wrap-reverse md:flex-nowrap gap-2 md:gap-6 mb-6">
                <Listbox value={displayYear} onChange={changeYear}>
                    <div className="relative">
                        <Listbox.Button className="relative w-64 text-left bg-white dark:bg-content-secondary-dark rounded-lg shadow-lg py-2 pl-3 pr-10 focus:outline-none focus-visible:ring-1 focus-visible:ring-secondary/10 dark:focus-visible:ring-secondary-dark/25">
                        ...
                        <AnimatedListbox className="absolute z-20 mt-1 w-64 py-1 rounded-md bg-white dark:bg-content-secondary-dark shadow-lg  focus:outline-none focus-visible:ring-1 focus-visible:ring-secondary/10 dark:focus-visible:ring-secondary-dark/25">
                            {years.map(year => (
