        ...
        <Header>
            <Listbox value={selected} onChange={setSelected}>
                <div className="relative z-50 max-w-full">
                    ...
                    <AnimatedListbox className="absolute top-[calc(100%_+_10px)] max-w-xs md:max-w-sm flex flex-col py-2 text-primary bg-content rounded shadow-2xl z-10 focus:outline-none focus-visible:ring-1 focus-visible:ring-black/10 dark:focus-visible:ring-white/25">
