...
import EventsContext, {GCalEvent} from '../../contexts/EventsContext';


type EventsProps = {viewDate: Moment};
export default function Events(props: EventsProps) {
    const {viewDate} = props;
    const {events, eventsError, fetchEvents} = useContext(EventsContext);
