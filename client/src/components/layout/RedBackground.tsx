        ...
        <svg width="100%" id="red-bg" viewBox="0 0 1440 700" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
                <linearGradient id="gradient">
                    <stop offset="5%" stopColor="#eb144c66"/>
                    <stop offset="95%" stopColor="#ff594c66"/>
                </linearGradient>
            </defs>
            <path
            ...
            <defs>
                <linearGradient id="gradient">
                    <stop offset="5%" stopColor="#eb144c88"/>
                    <stop offset="95%" stopColor="#ff594c88"/>
                </linearGradient>
            </defs>
            <path
            ...
            <defs>
                <linearGradient id="gradient">
                    <stop offset="5%" stopColor="#eb144cff"/>
                    <stop offset="95%" stopColor="#ff594cff"/>
                </linearGradient>
            </defs>
            <path
