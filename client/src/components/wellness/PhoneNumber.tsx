        ...
        <div className="space-y-4">
            ...
            <div className="space-y-3">
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded p-3">
                    <h3 className="font-medium text-red-800 dark:text-red-200">Request a crisis intervention team</h3>
                    <p className="text-red-700 dark:text-red-300 font-bold text-lg">911</p>
                    <p className="text-sm text-red-600 dark:text-red-400">Help is aviable</p>
                    <hr />
