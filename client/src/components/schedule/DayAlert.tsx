...
export default function DayAlert(props: DayAlertProps) {
    ...
    return (
        <Transition
            ...
            leaveTo="opacity-0"
        >
            <div className="day-alert absolute left-0 right-0 flex items-center mx-auto shadow-lg border-none bg-sidebar dark:bg-sidebar-dark rounded mx-3 md:mx-0 px-5 py-3 pr-16">
                {makeDateString()}
