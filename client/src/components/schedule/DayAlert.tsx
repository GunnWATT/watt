...
export default function DayAlert(props: DayAlertProps) {
    ...
    return (
        <Transition
            ...
            leaveTo="opacity-0"
        >
            <div className="day-alert absolute left-3 right-3 md:left-0 md:right-0 flex items-center mx-auto shadow-lg border-none bg-sidebar dark:bg-sidebar-dark rounded px-5 py-3 pr-16">
                {makeDateString()}
