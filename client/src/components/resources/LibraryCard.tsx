export default function LibraryCard() {
    return (
        <>
            ...
            <div className="hidden sm:flex sm:flex-col rounded-lg w-96 mx-auto bg-content-secondary dark:bg-background-dark overflow-hidden mb-4 shadow-lg" aria-hidden>
