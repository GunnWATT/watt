...
const clubs: {timestamp: string, data: {[key: string]: Club}} = {
    "timestamp": "2024-01-22T19:29:48.415Z",
    "data": {
        "11206": {
            "new": false,
        ...
        "82812": {
            "new": false,
            "name": "PC Programming Club",
            "tier": 2,
            "desc": "PC Programming Club aims to teach students about both high-level programming concepts such as web development and the underlying low-level hardware that everything runs on. Club members will be taught how to build and setup desktop computers from scratch, as well as how to develop for today's modern web landscape.",
            "day": "Friday",
            "time": "Lunch",
            "room": "N-113",
