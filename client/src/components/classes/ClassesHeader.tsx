        ...
        <Header>
            <Listbox value={selected} onChange={setSelected}>
                <div className="relative max-w-full">
                    ...
                    <AnimatedListbox className="absolute top-[calc(100%_+_10px)] max-w-xs md:max-w-sm flex flex-col py-4 text-primary dark:text-primary-dark bg-content rounded shadow-2xl z-10 focus:outline-none focus-visible:ring-1 focus-visible:ring-secondary/10 dark:focus-visible:ring-secondary-dark/25">
