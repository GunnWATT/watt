...
export default function PillClubComponent(props: Club & {id: string}) {
    ...
    return (
        <>
            <span className="text-sm cursor-pointer px-2.5 py-1 text-secondary rounded-full bg-black/5 dark:bg-black/20 hover:bg-black/10 dark:hover:bg-black/40 transition duration-75" onClick={() => setModal(true)}>
                {name}
            </span>
