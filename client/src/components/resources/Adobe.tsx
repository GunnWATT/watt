...
export default function Adobe() {
    return (
        <>
            ...
            <img src={adobe} alt="Adobe" className="w-[65ch] max-w-full rounded-lg mx-auto mb-4" />
            <p className="mb-4">
            ...
            <img src={creativeCloud} alt="Creative cloud" className="w-[65ch] max-w-full rounded-lg mx-auto" />
        </>
    )
}
