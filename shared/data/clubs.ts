...
const clubs: {timestamp: string, data: {[key: string]: Club}} = {
    ...
    "data": {
        ...
        "38064": {
            ...
            "type": "STEM",
            "tier": 1,
            "desc": "The Biochemistry Club is a community dedicated to exploring the molecular basis of life. We will explore in depth biomolecules, metabolic pathways, intercellular communication, and structural biochemistry. Our activities include interactive presentations, hands-on lab demonstrations, and guest lectures from researchers. We will also introduce research on the biochemical basis of various disorders and diseases. Our ultimate mission is to foster interest in the developing field of biochemistry.",
            "day": "Friday",
            "freq": "Once a week",
            "time": "Lunch",
            "room": "J-6",
        ...
        "40443": {
            "new": true,
            "name": "Current Events Club",
            "type": "Discussion",
            "tier": 1,
            "desc": "Current Events club is a place where students can learn about what's going on in the world every week. The goal for the club is to share and discuss interesting topics involving politics, human rights, and other events going on in the world right now. We will analyze these events through different perspectives, and look at the news and different articles of an event from varying media outlets (CNN, FOX, BBC) to examine biases and how what we see in the news affects our perception of events. More than this, we want a place where everyone has the opportunity to expand their worldview and think differently outside of what we learn in school. Students will be more informed on current topics and international affairs and be able to improve their articulation in civil discussions. Lastly, we will examine our own privileges and society in America compared to other places in the world.",
            "day": "Thursday",
            "freq": "Every Other Week",
            "time": "Lunch",
            "room": "C-4",
        ...
        "67777": {
            ...
            "type": "Culture, Religion, and Language",
            "tier": 1,
            "desc": "This club aims to support English Language Learner (ELL) students in adapting to Gunn society and the community. For club activities, we will offer insights about school events and culture, as well as the facilities around the school which many may not be familiar with, such as museums and landmarks in Palo Alto. We will also support each other by sharing each member’s cultures, learning from one another and building a strong community of diverse learners.",
            "day": "Thursday, Friday",
            "freq": "Once a week",
            "time": "Lunch",
            "room": "C-6",
        ...
        "79307": {
            "new": true,
            "name": "Homeless Action Club",
            "type": "Service and Wellbeing",
            "tier": 2,
            "desc": "The purpose of Homeless Action Club is to spread awareness and to identify ways to support the unhoused community. Potential activities include 1. collaborating with non-profit organizations to identify ways we can help the unhoused community 2. spreading awareness about volunteer opportunities that support the unhoused community, 3. setting up donation bins on campus,  4. making care packages for the unhoused community using donations collected.",
            "day": "Tuesday",
            "freq": "Every Other Week",
            "time": "Lunch",
            "room": "K-15",
        ...
        "82809": {
            "new": true,
            "name": "Marine Bio Club",
            "type": "STEM",
            "tier": 1,
            "desc": "Join the Marine Bio Club in J-4 and dive into the wonders of ocean life while helping to protect our planet’s most vital ecosystems! We aim to teach students about marine biology, from local species to global conservation efforts, through hands-on activities, documentaries, and discussions. Whether you're playing ocean species trivia or learning about coral reef ecosystems, you'll gain a deeper understanding of how we can all make a difference in the world. Together, we’ll work to inspire future environmental advocates and marine biologists while promoting ocean conservation and sustainability!",
            "day": "Monday",
            "freq": "Once a week",
            "time": "Lunch",
            "room": "J-4",
        ...
        "94615": {
            "new": true,
            "name": "Physical Therapy in Sports",
            "type": "STEM",
            "tier": 1,
            "desc": "We will go over common injuries and incorporate stretches that can help prevent these injuries. Ex. Week one will go over the prevention of ACL injuries and how they happen.",
            "day": "Tuesday",
            "freq": "Once a week",
            "time": "Lunch",
            "room": "J-2",
